...
const PCPartsList = ({ data, date }) => {
  ...
  useEffect(() => {
    const that = splitArrayIntoChunks(data, 50);
    setPagesData(that);
  }, []);
        ...
        {pagesData.map((pageData, pageIndex) => (
          ...
          <View>
            ...
            <View style={{ display: "flex", flexDirection: "row" }}>
              ...
              <View style={{ borderBottom: 1, width: "28%" }}>
                <Text style={{ fontSize: 8, margin: 2 }}>Desciption</Text>
              </View>
              <View style={{ borderBottom: 1, width: "30%" }}>
                <Text style={{ fontSize: 8, margin: 2 }}>WE Nest</Text>
              </View>
              <View style={{ borderBottom: 1, width: "25%" }}>
                <Text style={{ fontSize: 8, margin: 2 }}>Status</Text>
              </View>
            </View>
